<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="JobEntryView.aspx.cs" Inherits="JobEntryView" Title="Daily Job Entry Page" %>
   ...
   <div id="wrapper">
    ...
    <div class="row">
                <div class="col-lg-12">
                   ...
                   <asp:GridView ID="grdJobEntry" runat="server" AllowPaging="true" Font-Size="Small"
                       AutoGenerateColumns="False" PageSize="50000" CssClass="Grid" PagerStyle-CssClass="pgr"
                        AlternatingRowStyle-CssClass="alt" EmptyDataText="No Such Data Found" 
                           DataKeyNames="EJOBID" ShowFooter="true" AllowSorting="True" onrowdatabound="grdJobEntry_RowDataBound"
                           > 
                        ...
                        <asp:TemplateField HeaderText="Id" Visible="false">
                          <ItemTemplate>
                          <asp:Label id="lblId" runat="server" Text='<%#Eval("EJOBID")%>'></asp:Label>
                          </ItemTemplate>
                          </asp:TemplateField>
