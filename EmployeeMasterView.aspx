<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="EmployeeMasterView.aspx.cs" Inherits="EmployeeMasterView" Title="Employee Master" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title">Emp View</h3>
                        </div>
                        <div class="panel-body">
                 
                            
                            <div  style="overflow:scroll; height:370px; width:737px; background-color:White">
                   <asp:GridView ID="grdEmpView" runat="server" AllowPaging="true" Font-Size="Small"
                       AutoGenerateColumns="False" PageSize="50000" CssClass="Grid" PagerStyle-CssClass="pgr"
                        AlternatingRowStyle-CssClass="alt" EmptyDataText="No Such Data Found" 
                           ...
                           onrowcancelingedit="grdEmpView_RowCancelingEdit" 
                           onrowdatabound="grdEmpView_RowDataBound" 
                           onrowdeleting="grdEmpView_RowDeleting" 
                           onrowediting="grdEmpView_RowEditing" 
                           onrowupdating="grdEmpView_RowUpdating">
