<%@ Page Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="IncSalesTaxRpt.aspx.cs" Inherits="IncSalesTaxRpt" Title="Invoice SalesTax Report View" %>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"> Service Invoice Report</h3>
                        </div>
                   ...
                   <asp:GridView ID="grdIncSalesTax" runat="server" AllowPaging="true" Font-Size="Small"
